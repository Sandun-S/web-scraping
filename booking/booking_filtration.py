...
class BookingFiltration:
    ...
    def apply_star_rating(self, *star_values):
        # --- CHANGE 2: Updated find_element_by_id to By.ID ---
        star_filtration_box = self.driver.find_element(By.ID, 'filter_class')
        
        # --- CHANGE 3: Updated find_elements_by_css_selector to By.CSS_SELECTOR ---
    ...
    def sort_price_lowest_first(self):
        # --- CHANGE 4: Updated find_element_by_css_selector to By.CSS_SELECTOR ---
